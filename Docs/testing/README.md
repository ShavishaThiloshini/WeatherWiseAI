...
Day 02 QA foundation for WeatherWise AI. Placed under `Docs/` to match the existing project documentation layout.
...
Requirement-level cases remain in [`../TestStrategy.md`](../TestStrategy.md).
